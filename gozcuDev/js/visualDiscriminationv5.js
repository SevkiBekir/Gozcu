...
lib.ssMetadata = [
		{name:"visualDiscriminationv5_atlas_", frames: [[1368,0,610,525],[1368,527,610,525],[1368,1054,610,525],[1680,2341,138,150],[1002,2320,353,190],[1368,1581,474,626],[1844,1756,112,199],[1820,2341,132,144],[0,780,1366,768],[0,1550,1366,768],[1002,2539,416,86],[1368,2209,600,130],[1844,1581,179,173],[1844,1957,162,132],[0,2320,1000,1000],[1820,2487,126,126],[1357,2341,321,196],[0,0,1366,778]]}
];
...
(lib.button1 = function() {
	this.spriteSheet = ss["visualDiscriminationv5_atlas_"];
	this.gotoAndStop(0);
...
(lib.visiualdiscriminationbackground2 = function() {
	this.spriteSheet = ss["visualDiscriminationv5_atlas_"];
	this.gotoAndStop(17);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
// stage content:
(lib.visualDiscriminationv5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		if(!this.deneme_change_cbk) {
			function deneme_change(evt) {
				// Start your custom code
				console.log(evt.target.value);
				generateStorySelectionHTMl(evt.target.value);
				
				// End your custom code
			}
			$("#dom_overlay_container").on("change", "#deneme", deneme_change.bind(this));
			this.deneme_change_cbk = true;
		}
		
		
		
		if(!this.time_change_cbk) {
			function time_change(evt) {
				// Start your custom code
				console.log(evt.target.value);
				generateDurationHTMl(evt.target.value);
				
				// End your custom code
			}
			$("#dom_overlay_container").on("change", "#time", time_change.bind(this));
			this.time_change_cbk = true;
		}
	...
	this.frame_3 = function() {
		...
		function sendData(mouseX = 0, mouseY = 0, time = 0,isMousePointer = false){
            ...
            var siteURL = "http://gozcu.local/gozcuDev/";
			if(!isMousePointer){
	...
	this.timeline.addTween(cjs.Tween.get(this.mcLoader8).wait(3).to({_off:false},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcLoader6).wait(3).to({_off:false},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcLoader4).wait(3).to({_off:false},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcLoader2).wait(3).to({_off:false},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnKomidin).wait(4).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnSaat).wait(4).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnIsik).wait(4).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCerceve).wait(4).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnVazo).wait(4).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcTickMeyveSuyu).wait(3).to({_off:false},0).wait(1).to({x:1001,y:652.8},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcTickGunes).wait(3).to({_off:false},0).wait(1).to({x:858.2,y:134.3},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcTickTas).wait(3).to({_off:false},0).wait(1).to({x:1133.7,y:60},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcTickYildiz).wait(3).to({_off:false},0).wait(1).to({x:937.3,y:303.8},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcTickTop).wait(3).to({_off:false},0).wait(1).to({x:1285.9,y:528.9},0).wait(1));

	// parameters
	this.deneme = new lib.an_ComboBox({'id': 'deneme', 'label':'', 'items':'dummy, dummy, items, 2, label, 0, , , data, 0, , , 2, Plaj, 1, Oturma Odası, 2', 'value':'0', 'disabled':false, 'visible':true, 'class':'form-control'});

	this.deneme.setTransform(250,200,3.2,2.728);



	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.deneme}]}).to({state:[]},1).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnKapi).wait(1).to({_off:false},0).to({_off:true},2).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnGunes).wait(3).to({_off:false},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnMeyveSuyu).wait(3).to({_off:false},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnTas).wait(3).to({_off:false},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnYildiz).wait(3).to({_off:false},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnTop).wait(3).to({_off:false},0).to({_off:true},1).wait(1));

	// btn
	this.btnStart = new lib.btnBaslaDiyor();
	this.btnStart.parent = this;
	this.btnStart.setTransform(594.6,335.7,1,1,0,0,0,219,99);
	...
	// background
	this.time = new lib.an_ComboBox({'id': 'time', 'label':'', 'items':'dummy, dummy, items, 2, label, 0, , , data, 0, , , 4, 2 saniye, 2, 4 saniye, 4, 6 saniye, 6, 8 saniye, 8', 'value':'0', 'disabled':false, 'visible':true, 'class':'form-control'});

	this.time.setTransform(970,200,3.2,2.728,0,0,0,0.2,0.1);

	this.instance_2 = new lib.visiualdiscriminationbackground2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(1,0);

	this.instance_3 = new lib.newbeachvisualdisciriminationyeni();
	this.instance_3.parent = this;

	this.instance_4 = new lib.newlivingvisualdiscirimination2();
	this.instance_4.parent = this;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.time}]}).to({state:[]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_4}]},1).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/visualDiscriminationv5_atlas_.png?1490823031466", id:"visualDiscriminationv5_atlas_"},
		{src:"sounds/complete.mp3?1490823032035", id:"complete"},
		{src:"sounds/odaklanmasüresi.mp3?1490823032035", id:"odaklanmasüresi"},
		{src:"sounds/oyununhikayesi.mp3?1490823032035", id:"oyununhikayesi"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1490823032035", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1490823032035", id:"sdk/anwidget.js"},
		{src:"components/ui/src/css.js?1490823032035", id:"an.CSS"},
		{src:"components/ui/src/combobox.js?1490823032035", id:"an.ComboBox"}
	],
	preloads: []
};
