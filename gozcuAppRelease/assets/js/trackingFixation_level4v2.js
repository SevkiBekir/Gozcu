...
lib.ssMetadata = [
		{name:"trackingFixation_level4v2_atlas_", frames: [[1806,2302,170,155],[579,3656,121,113],[1806,1806,185,175],[1806,2145,170,155],[0,0,1366,778],[1204,1707,100,69],[457,3610,120,115],[1806,2900,104,102],[1204,1550,155,155],[1059,2884,120,115],[1806,2616,150,140],[1059,2754,133,128],[1806,1983,170,160],[1806,2758,150,140],[0,1550,600,600],[0,2152,600,600],[1516,3010,455,449],[1368,0,600,600],[602,2152,600,600],[602,3205,455,449],[0,780,1366,768],[1368,1204,600,600],[1204,2408,600,600],[602,2754,455,449],[1963,2459,82,120],[1368,602,600,600],[0,2754,600,600],[1059,3010,455,449],[1505,3461,444,202],[1059,3461,444,202],[1970,0,59,87],[1204,1806,600,600],[602,1550,600,600],[0,3356,455,449],[1970,89,59,87],[457,3356,130,125],[1806,2459,155,155],[457,3483,130,125]]}
];
...
(lib.boga = function() {
	this.spriteSheet = ss["trackingFixation_level4v2_atlas_"];
	this.gotoAndStop(0);
...
(lib.btnYilan = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-34,-95,1.2,1.2);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FF00").s().p("AufOOIAA8bIc/AAIAAcbg");
	this.shape.setTransform(36.9,-11.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.shape},{t:this.instance}]},3).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-34,-95,156,150);
...
// stage content:
(lib.trackingFixation_level4v2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_1 = function() {
		...
		function eventTicker(event){
			...
			if(currentObject[0].y > 650 && currentObject[0].x > 725){
				createjs.Ticker.removeEventListener("tick", eventTicker);
	...
	this.frame_2 = function() {
		...
		function eventTicker2(event){
			...
			if(currentObject[0].y < 85 && currentObject[0].x < 150){
	...
	this.btnHemsterTwo.setTransform(797.5,647.2);
	...
	this.btnKediTwo.setTransform(810.8,646.5);
	...
	this.btnYilanTwo.setTransform(789.2,672.4);
	...
	this.btnBoga.setTransform(1251.8,139.7,1.493,1.492,0,0,180);
	new cjs.ButtonHelper(this.btnBoga, 0, 1, 1);

	this.btnBogaTwo = new lib.btnBogaTwo();
	this.btnBogaTwo.parent = this;
	this.btnBogaTwo.setTransform(782,673.8,1.493,1.492,0,0,180);
	...
	this.mcFistik.setTransform(747.1,711.4);
	this.mcFistik._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcFistik).wait(1).to({_off:false},0).wait(1).to({x:82,y:142.9},0).to({_off:true},1).wait(1));

	// mcSut
	this.mcSut = new lib.mcSut();
	this.mcSut.parent = this;
	this.mcSut.setTransform(752,690);
	this.mcSut._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcSut).wait(1).to({_off:false},0).wait(1).to({x:66.9,y:141.3},0).to({_off:true},1).wait(1));

	// mcYumurta
	this.mcYumurta = new lib.mcYumurta();
	this.mcYumurta.parent = this;
	this.mcYumurta.setTransform(752.2,694.4);
	this.mcYumurta._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcYumurta).wait(1).to({_off:false},0).wait(1).to({x:66.1,y:138.7},0).to({_off:true},1).wait(1));

	// mcRedFlag
	this.mcRedFlag = new lib.mcRedFlag();
	this.mcRedFlag.parent = this;
	this.mcRedFlag.setTransform(759.1,666.5,1.31,1.31);
	this.mcRedFlag._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcRedFlag).wait(1).to({_off:false},0).wait(1).to({x:90.7,y:147.5},0).to({_off:true},1).wait(1));

	// Layer 11
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AmFFLIK7rhIBQBMIq7Lhg");
	this.shape.setTransform(1171.9,249.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("Am5kAIBBhZIMyJbIhBBZg");
	this.shape_1.setTransform(677.3,622.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape_1}]},1).to({state:[]},1).wait(1));

	// Layer 11
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AmFFLIK7rhIBQBMIq7Lhg");
	this.shape_2.setTransform(541.9,916.4);
	...
	this.shape_3.graphics.f("#000000").s().p("AmFFLIK7rhIBQBMIq7Lhg");
	this.shape_3.setTransform(626.1,825.7);
	...
	this.shape_4.graphics.f("#000000").s().p("Am5kBIBBhYIMyJbIhBBYg");
	this.shape_4.setTransform(141.3,226.9);
	this.shape_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(2).to({_off:false},0).to({_off:true},1).wait(1));

	// Layer 11
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AmFFKIK6rgIBRBNIq8Lfg");
	this.shape_5.setTransform(993.6,437.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("Am4kAIBBhZIMwJaIhABZg");
	this.shape_6.setTransform(468.9,468.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[]},1).wait(1));

	// Layer 11
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AmFFLIK7rhIBQBMIq7Lhg");
	this.shape_7.setTransform(1082.8,343.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("Am6kBIBChYIMyJaIhCBZg");
	this.shape_8.setTransform(573.1,545.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[]},1).wait(1));

	// Layer 15
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AmFFKIK8rgIBPBNIq7Lgg");
	this.shape_9.setTransform(897.8,535.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("Am6kBIBDhZIMxJcIhCBYg");
	this.shape_10.setTransform(360.2,385.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[]},1).wait(1));

	// Layer 16
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("AmFFKIK7rgIBQBNIq7Lgg");
	this.shape_11.setTransform(801.5,636.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("Am5kAIBChZIMxJaIhCBZg");
	this.shape_12.setTransform(247.5,302.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).to({state:[]},1).wait(1));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:assetAddres +"images/trackingFixation_level4v2_atlas_.png", id:"trackingFixation_level4v2_atlas_"}
	],
	preloads: []
};
